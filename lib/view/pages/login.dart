...
import 'package:attendance/view/pages/guestwait_screen.dart';
import 'package:attendance/view/pages/register_screen.dart';
                          ...
                          child: GetBuilder<TabindexController>(
                            ...
                            builder: (controller) {
                              return TabBar(
                                  ...
                                  indicator:
                                      BoxDecoration(color: Strings.ColorBlue),
                                  onTap: (index) async {
